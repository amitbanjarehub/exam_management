    ...
    >
      <Stack spacing={2} sx={{ width: "100%", pl: 0 }}>
        ...
        <Grid container spacing={1} sx={{ pl: "4px", pr: "4px" }}>
          ...
          <Grid item xs={4}>
            <Stack direction="column" alignItems="center" spacing={1}>
              <Typography sx={{ fontSize: "12px", fontWeight: "bold" }}>Exam Name</Typography>
              <Typography sx={{ fontSize: "12px" }}>TET</Typography>
            </Stack>
          </Grid>
          <Grid item xs={4}>
            <Stack direction="column" alignItems="center" spacing={1}>
              <Typography sx={{ fontSize: "12px", fontWeight: "bold" }}>Date</Typography>
        ...
        <Grid container spacing={1}>
          <Grid item xs={4}>
            <Stack direction="column" alignItems="center" spacing={1}>
              <Typography sx={{ fontSize: "12px", fontWeight: "bold" }}>Start Time</Typography>
              <Typography sx={{ fontSize: "12px" }}>10:00 AM</Typography>
            </Stack>
          </Grid>
          <Grid item xs={4}>
            <Stack direction="column" alignItems="center" spacing={1}>
              <Typography sx={{ fontSize: "12px", fontWeight: "bold" }}>End Time</Typography>
              <Typography sx={{ fontSize: "12px" }}>01:00 PM</Typography>
            </Stack>
          </Grid>
          <Grid item xs={4}>
            <Stack direction="column" alignItems="center" spacing={1}>
              <Typography sx={{ fontSize: "12px", fontWeight: "bold" }}>Countdown</Typography>
